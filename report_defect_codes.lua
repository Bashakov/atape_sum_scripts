...
--	FASTENER_ = 	{ "090004000478", "Отсутствующие или изломанные шурупы"},
	...
	FASTENER_DEFECT_CURVE_GROUP_3 		= { "090004017095", "Отсутствует или дефектное скрепление в кривых радиусом 650 м и менее более чем на 5 шпалах подряд по одной нити"},
	...
	FASTENER_DEFECT_STRAIGHT_GROUP_3 	= { "090004017098", "Отсутствует или дефектное скрепление в прямых и кривых радиусом более 650 м более чем на 3 шпалах подряд по одной нити"},
