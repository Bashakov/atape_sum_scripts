local codes = {
	...
	-- https://bt.abisoft.spb.ru/view.php?id=765
	JOINT_NEIGHBO_BLIND_GAP_TWO		=	{ "090004012061", "Наличие двух подряд слитых зазоров"},
	JOINT_NEIGHBO_BLIND_GAP_MORE_LEFT	=	{ "090004015838", "Три и более слепых (нулевых) зазоров подряд по левой нити"},
	JOINT_NEIGHBO_BLIND_GAP_MORE_RIGTH	=	{ "090004015839", "Три и более слепых (нулевых) зазоров подряд по правой нити"},
...
--	FASTENER_ = 	{ "090004003539", "Отсутствует скрепление"},
	FASTENER_MISSING_CLAMP = 		{ "090004000394", "Отсутствует клемма"}, --!!! для скрепления АРС отсутствие клеммы меняем на "Отсутствует скрепление" 090004003539, для скрепления КБ 
	FASTENER_MISSING_BOLT = 		{ "090004000394", "Отсутствуют закладные болты"}, --!!! заменен на альтернативный
	FASTENER_MISSING_CLAMP_BOLT = 	{ "090004000394", "Отсутствуют клеммные болты"}, --!!! заменен на альтернативный
...
--	FASTENER_ = 	{ "090004000478", "Отсутствующие или изломанные шурупы"},
	...
	SLEEPER_FRACTURE_FERROCONCRETE ={ "090004012315", "Негодная железобетонная шпала"},
