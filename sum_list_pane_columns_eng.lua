...
column_rail = 
{
	...
	text = function(row)
		...
		return rail_mask == 1 and 'KUP' or 'KOR'
	end,
	sorter = function(mark)
...
column_surf_defect_type = make_column_surf_defect('Type', 'SurfaceFault')
column_surf_defect_area = make_column_surf_defect('S', 'SurfaceArea')
column_surf_defect_len = make_column_surf_defect('L', 'SurfaceLength')  -- https://bt.abisoft.spb.ru/view.php?id=251#c592
column_surf_defect_wdh = make_column_surf_defect('W', 'SurfaceWidth') 
