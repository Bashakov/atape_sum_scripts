local codes = {
	...
	JOINT_ATYPICAL 					= 	{ "090004017122", "Нетиповые и посторонние предметы в стыке"},

	-- 1.7 Определение наличия и состояния рельсовых соединителей
	JOINT_WELDED_BOND_FAULT_WAY   	=	{ "090004000521", "Дефектный соединитель"}, -- https://bt.abisoft.spb.ru/view.php?id=765#c3706
	JOINT_WELDED_BOND_FAULT_JOINT   =	{ "090004000995", "Дефектный соединитель"},
	JOINT_WELDED_BOND_FAULT_SCB		=	{ "090004003583", "Дефектный соединитель"},

	JOINT_WELDED_BOND_MISSING_WAY	=	{ "090004004928", "Отсутствует приварной рельсовый соединитель"},
	JOINT_WELDED_BOND_MISSING_JOINT	=	{ "090004012367", "Отсутствует приварной рельсовый соединитель"},
	JOINT_WELDED_BOND_MISSING_SCB	=	{ "090004003583", "Отсутствует приварной рельсовый соединитель"},

	JOINT_CONNECTOR_FAULT_WAY		= 	{ "090004004927", "Отсутствие дублирующего соединителя" },
	JOINT_CONNECTOR_FAULT_JOINT		= 	{ "090004012371", "Отсутствие дублирующего соединителя" },
	JOINT_CONNECTOR_FAULT_SCB		= 	{ "090004003581", "Отсутствие дублирующего соединителя" },

	JOINT_CONNECTOR_SCREW_FAULT_WAY	= 	{ "090004000520", "Отсутствие гаек на штепселе соединителя" },
	JOINT_CONNECTOR_SCREW_FAULT_JOINT= 	{ "090004000994", "Отсутствие гаек на штепселе соединителя" },
	JOINT_CONNECTOR_SCREW_FAULT_SCB	= 	{ "090004003582", "Отсутствие гаек на штепселе соединителя" },

	JOINT_CONNECTOR_HOLE_MISSING_WAY=	{ "090004004926", "Отсутствие отверстия под соединители" },

	ISO_CONNECTOR_INSUFFICIENCY_WAY	= 	{ "090004012114", "Недостаточное крепление дроссельных перемычек"},
	ISO_CONNECTOR_INSUFFICIENCY_JOINT= 	{ "090004012386", "Недостаточное крепление дроссельных перемычек"},
	ISO_CONNECTOR_INSUFFICIENCY_SCB	= 	{ "090004007699", "Недостаточное крепление дроссельных перемычек"},
...
--	FASTENER_ = 	{ "090004000389", "Дефектные клеммы"},
	FASTENER_DEFECT_LINING = 	{ "090004000402", "Отсутствует/дефектная подкладка"},
